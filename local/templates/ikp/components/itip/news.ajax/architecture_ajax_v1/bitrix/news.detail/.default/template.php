...
<?if(isset($arResult['PROPERTIES']['PROJECT_VIDEO_H264']) && $arResult['PROPERTIES']['PROJECT_VIDEO_H264']['VALUE'] > 0):?>
	<?
		$poster = "";
		if(isset($arResult['PROPERTIES']['PROJECT_VIDEO_POSTER']) && $arResult['PROPERTIES']['PROJECT_VIDEO_POSTER']['VALUE'] > 0) {
			$poster = CFile::GetPath($arResult['PROPERTIES']['PROJECT_VIDEO_POSTER']['VALUE']);
		}		
	?>
	<video class="video" poster="<?=$poster?>"
		<?//src="https://anima-uploads.s3.amazonaws.com/projects/60f530b1784cfe563d205df5/files/baltic-sample-1920-820-min-px.mp4"*/?>
		loop="" 
		autoplay="autoplay"
		playsinline="" muted="">
		<?
		if(isset($arResult['PROPERTIES']['PROJECT_VIDEO_H264']) && $arResult['PROPERTIES']['PROJECT_VIDEO_H264']['VALUE'] > 0) {
			$h264 = CFile::GetPath($arResult['PROPERTIES']['PROJECT_VIDEO_H264']['VALUE']);
			?>
			<source src="<?=$h264;?>" type="video/mp4" />
			Video tag not supported. Download the video <a href="<?=$h264?>">here</a>
			<?
		}
		?>
		<?
		if(isset($arResult['PROPERTIES']['PROJECT_VIDEO_WEBM']) && $arResult['PROPERTIES']['PROJECT_VIDEO_WEBM']['VALUE'] > 0) {
			$webM = CFile::GetPath($arResult['PROPERTIES']['PROJECT_VIDEO_WEBM']['VALUE']);
			?>
...
<?elseif(isset($arResult['PROPERTIES']['PROJECT_SLIDER_TOP'])):?>
	<? 
		foreach($arResult['PROPERTIES']['PROJECT_SLIDER_TOP']['VALUE'] AS $fileId) {
			$imgSliderPath = CFile::GetPath($fileId);
			$img4K = CFile::ResizeImageGet($fileId, array("width" => 891, "height" => 501), BX_RESIZE_IMAGE_PROPORTIONAL, false);
			$imgMD = CFile::ResizeImageGet($fileId, array("width" => 412, "height" => 232), BX_RESIZE_IMAGE_PROPORTIONAL, false);
			$imgSM = CFile::ResizeImageGet($fileId, array("width" => 274, "height" => 154), BX_RESIZE_IMAGE_PROPORTIONAL, false);
			$topSliderListImg .= '<img class="detail-slider__img" 
				data-lg="'.$img4K['src'].'" 
				data-md="'.$imgMD['src'].'" 
				data-sm="'.$imgSM['src'].'" 
				src="'.$imgSliderPath.'" 
...
<?else:?>
	<? 
		$topSliderListImg = '<img class="detail-slider__img" src="'.$arResult["PREVIEW_PICTURE"]["SRC"].'" alt="'.$arResult["PREVIEW_PICTURE"]["ALT"].'" />'; 
	?>
<?endif;?>

<?if($topSliderListImg != ''): //Start TopSider?>
<div class="detail-slider">
	<? echo  $topSliderListImg; ?>

	<div class="detail-slider__arrow-next">
	...
	<div class="detail-slider__arrow-prev">
		<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" stroke-width="2" stroke="#fff" fill="none">
			<polyline points="45.15 57.47 19.88 30.84 45.15 6.58" />
		</svg>
	</div>
	<div class="detail-slider__view-button">
		<span class="detail-slider__view-button--box-1"></span>
		<span class="detail-slider__view-button--box-2"></span>
		<span class="detail-slider__view-button--box-3"></span>
		<span class="detail-slider__view-button--box-4"></span>
	</div>
	<div class="detail-slider__view-button-info">
		<span>Плитка</span>
		<span></span>
	</div>
	<svg class="detail-slider__fullscreen" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
		<path d="M1 13.9331V18.9998H5.97015" stroke="#F5F5F5" stroke-miterlimit="10" />
		<path d="M19.0004 13.9331V18.9998H14.0303" stroke="#F5F5F5" stroke-miterlimit="10" />
		<path d="M1 5.93335V1H5.97015" stroke="#F5F5F5" stroke-miterlimit="10" />
		<path d="M19.0004 5.93335V1H14.0303" stroke="#F5F5F5" stroke-miterlimit="10" />
	</svg>
	<div class="detail-slider__fullscreen-info">
		<span>Полный экран</span>
		<span></span>
	</div>
	<div class="detail-slider__fullscreen-mini">
		<svg width="12" height="12" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
			<path d="M1 9.62201V12.9997H4.31335M13 9.62201V12.9997H9.68665M1 4.28882V1H4.31335M12.9999 4.28882V1H9.68654" stroke="white" stroke-miterlimit="10" />
		</svg>
	</div>

	<div class="detail-slider__fullscreen-icons">
		<p></p>
		<a class="download-link" download></a>
		<div class="download-link-info">
			<span><?=GetMessage("DOWNLOAD_LINK");?></span>
			<span></span>
		</div>
		<svg class="share" width="21" height="16" viewBox="0 0 21 16" fill="none" xmlns="http://www.w3.org/2000/svg">
		...
		<div class="share-info">
			<span><?=GetMessage("SHARED_LINK");?></span>
			<span></span>
		</div>
		<svg class="fullscreen--close-icon" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
			<path d="M1 1L19 19" stroke="#F5F5F5" stroke-miterlimit="10" />
			<path d="M1 19L19 1" stroke="#F5F5F5" stroke-miterlimit="10" />
		</svg>
		<div class="fullscreen--close-icon-info">
			<span><?=GetMessage("CLOSE_WINDOW");?></span>
			<span></span>
		</div>
	</div>
	...
	<div class="popup">
		<div class="popup-body">
			<div class="popup-content">
				<div class="popup-content--close"><svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
				...
				<div class="popup-content--title"><?=GetMessage("SHARE_PHOTO");?></div>
				<div class="popup-content--text"><?=GetMessage("SHARE_PHOTO_LONG");?></div>
				<p class="popup-content--field"></p>

				<div class="popup-content--socials">
					<a class="popup-content--socials-fb" href="#" target="_blank">
					...
					<a class="popup-content--socials-vk" href="#" target="_blank">
					...
					<a class="popup-content--socials-tg" href="#" target="_blank">
					...
					<a class="popup-content--socials-wa" href="#" target="_blank">
					...
					<a class="popup-content--socials-vb" href="#" target="_blank">
					...
					<a class="popup-content--socials-pt" href="#" target="_blank">
	...
	<div class="popup--bottom-frame">
		<div class="popup--bottom-frame--photo"></div>
		<p><?=GetMessage("LINK_TO_IMAGE_COPY");?></p>
	</div>
</div>
<?endif; //EndTopSider?>
...
<div class="main-container">
	<div class="under-slider-info">
		<div class="bread-crumbs">
			<?
			// Проекты / Архитектура
			$APPLICATION->IncludeComponent("bitrix:breadcrumb", "ikp", Array(
		...
		<?if($topSliderListImg != ''): //TopSider count?>
		<div class="detail-slider__info">
			<div class="detail-slider__info--current-img"></div>
			<div class="detail-slider__info--slash">/</div>
			<div class="detail-slider__info--all-img"></div>
		</div>
		<?endif;?>
	</div>

	<div class="detail-info">
		<h1><?=$arResult['DISPLAY_PROPERTIES']['PROJECT_MAIN_TITLE_'.mb_strtoupper(LANGUAGE_ID)]['DISPLAY_VALUE'];?></h1>

		<div class="detail-info__status">
			<p class="detail-info__bold"><?=GetMessage("PROJECT_STATUS");?></p>
			<?
				$prjStatus = $cDictionary->getElementFromDictionaryByXmlId(5, $arResult['DISPLAY_PROPERTIES']['PROJECT_STATUS']['VALUE']);
			?>
			<p><?=$prjStatus['UF_NAME_'.mb_strtoupper(LANGUAGE_ID)];?></p>
		</div>

		<div class="detail-info__all-area">
			<p class="detail-info__bold"><?=GetMessage("PROJECT_FULLAREA");?></p>
			<p><?=number_format($arResult['DISPLAY_PROPERTIES']['PROJECT_FULL_AREA']['DISPLAY_VALUE'], 0, '', '&nbsp;');?>&nbsp;<span>м<sup>2</sup></span></p>
		</div>

		<div class="detail-info__type">
			<p class="detail-info__bold"><?=GetMessage("PROJECT_TYPE");?></p>
			<?
				$prjType = $cDictionary->getElementFromDictionaryByXmlId(2, $arResult['DISPLAY_PROPERTIES']['PROJECT_TYPE']['VALUE']);
			?>
			<p><?=$prjType['UF_NAME_'.mb_strtoupper(LANGUAGE_ID)];?></p>
		</div>

		<?if(isset($arResult['DISPLAY_PROPERTIES']['PROJECT_DATE_DEV_'.mb_strtoupper(LANGUAGE_ID)])):?>
			<div class="detail-info__dev">
				<p class="detail-info__bold"><?=GetMessage("PROJECT_DONE");?></p>
				<p><?=$arResult['DISPLAY_PROPERTIES']['PROJECT_DATE_DEV_'.mb_strtoupper(LANGUAGE_ID)]['DISPLAY_VALUE']?></p>
			</div>
		<?endif;?>

		<?if(isset($arResult['DISPLAY_PROPERTIES']['PROJECT_LOCATION_'.mb_strtoupper(LANGUAGE_ID)])):?>
			<div class="detail-info__place">
				<p class="detail-info__bold"><?=GetMessage("PROJECT_LOCATION");?></p>
				<p><?=$arResult['DISPLAY_PROPERTIES']['PROJECT_LOCATION_'.mb_strtoupper(LANGUAGE_ID)]['DISPLAY_VALUE']?>
					<?if(isset($arResult['DISPLAY_PROPERTIES']['PROJECT_LATLONG'])):?>
					<script>
						var latlong = "<?=$arResult['DISPLAY_PROPERTIES']['PROJECT_LATLONG']['VALUE'];?>";
					</script>
		...
		<div class="detail-info__autors">
			<p class="detail-info__bold"><?=GetMessage("PROJECT_AUTORS");?></p>
			<p>
				<?
				$profile = "/institute/staff";
				$filter = Array(
					"ID" => implode(" | ",$arResult['DISPLAY_PROPERTIES']['PROJECT_AUTORS']['VALUE']),
				);
				$rsUsers = CUser::GetList(($by="last_name"), ($order ="asc"), $filter);
				while($arUser = $rsUsers->fetch()) {
					?>
						<a href="<?=$profile."/".$arUser['ID']."/"?>"><?=$arUser['LAST_NAME'].($arUser['NAME'] != "" ? " ".mb_substr($arUser['NAME'],0,1)."." : "").($arUser['SECOND_NAME'] != "" ? " ".mb_substr($arUser['SECOND_NAME'],0,1) : "");?></a>
					<?
				}
				?>
			</p>
		...
		<div class="detail-info__coautors">
			<p class="detail-info__bold"><?=GetMessage("PROJECT_CO_AUTHORS");?></p>
			<p class="detail-info__coautors-field">
				<?=$arResult['DISPLAY_PROPERTIES']['PROJECT_CO_AUTHORS_'.mb_strtoupper(LANGUAGE_ID)]['DISPLAY_VALUE'];?>
			</p>
		...
		<div class="detail-info__right">
			<?=$arResult['DISPLAY_PROPERTIES']['PROJECT_MAIN_DESCRIPTION_'.mb_strtoupper(LANGUAGE_ID)]['DISPLAY_VALUE'];?>
		</div>
	</div>
</div>

<?if(isset($arResult['DISPLAY_PROPERTIES']['PROJECT_SLIDER_MIDLE']) && count($arResult['DISPLAY_PROPERTIES']['PROJECT_SLIDER_MIDLE']['VALUE']) > 0):?>
<div class="carousel__status">
	<?=$arResult['DISPLAY_PROPERTIES']['PROJECT_SLIDER_TITLE_'.mb_strtoupper(LANGUAGE_ID)]['DISPLAY_VALUE'];?>
</div>
<div class="carousel">
	<div class="carousel-wrapper">
		<?
		//var_dump($arResult['DISPLAY_PROPERTIES']['PROJECT_SLIDER_MIDLE']);
		foreach($arResult['DISPLAY_PROPERTIES']['PROJECT_SLIDER_MIDLE']['VALUE'] AS $sliderItem) {
			$sPhoto = CFile::GetPath($sliderItem);
		?>
	...
	<div class="carousel__fullscreen-icons">
		<p><?=$arResult['DISPLAY_PROPERTIES']['PROJECT_MAIN_TITLE_'.mb_strtoupper(LANGUAGE_ID)]['~VALUE']['TEXT'];?></p>
...
<div class="carousel__popup">
	<div class="carousel__popup-body">
		<div class="carousel__popup-content">
			...
			<div class="carousel__popup-content--title"><?=GetMessage("SHARED_PHOTO");?></div>
			<div class="carousel__popup-content--text"><?=GetMessage("SHARED_PHOTO_LONG");?></div>
...
<div class="carousel__numbers">
	<span class="active">1</span><span>/</span><span class="total"><?=count($arResult['DISPLAY_PROPERTIES']['PROJECT_SLIDER_MIDLE']['VALUE']);?></span>
</div>
<?endif;?>

<div class="detail-description">
	<?=$arResult['DISPLAY_PROPERTIES']['PROJECT_ADV_DESCRIPTION_'.mb_strtoupper(LANGUAGE_ID)]['DISPLAY_VALUE'];?>
</div>

<?if(isset($arResult['DISPLAY_PROPERTIES']['PROJECT_PHOTO_GRID']) && count($arResult['DISPLAY_PROPERTIES']['PROJECT_PHOTO_GRID']['VALUE']) > 0):?>
<section class="detail-slabs">
	<div class="detail-slabs__status">
		<div><?=$arResult['DISPLAY_PROPERTIES']['PROJECT_GRID_TITLE_'.mb_strtoupper(LANGUAGE_ID)]['DISPLAY_VALUE'];?></div>
		<div>
			<p><?=GetMessage("ALL_PHOTO");?>:</p>
			<p class="-detail-slabs__status--number"><?=count($arResult['DISPLAY_PROPERTIES']['PROJECT_PHOTO_GRID']['VALUE'])?></p>
		</div>
	</div>
	...
	<div class="detail-slabs__photos">
		...
		foreach($arResult['DISPLAY_PROPERTIES']['PROJECT_PHOTO_GRID']['VALUE'] AS $gridItem) {
			$gPhoto = CFile::GetPath($gridItem);
		?>
	...
	<div class="slabs__popup">
		<div class="slabs__popup-body">
			<div class="slabs__popup-content">
				...
				<div class="slabs__popup-content--title"><?=GetMessage("SHARE_PHOTO");?></div>
				<div class="slabs__popup-content--text"><?=GetMessage("SHARE_PHOTO_LONG");?></div>
