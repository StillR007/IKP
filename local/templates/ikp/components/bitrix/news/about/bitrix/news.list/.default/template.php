...
<link rel="stylesheet" href="<?= SITE_TEMPLATE_PATH ?>/css/masterplans_detail.min.css">


<div class="main-container">
	<div class="about-main-slider">
		<img class="about-main-slider__img" src="<?= SITE_TEMPLATE_PATH ?>/img/about-main-slider-photo.jpg">
	...
	<div class="about-staff">
		...
		<div class="about-staff__employees">
			<div class="about-staff__employee">
				<img src="/upload/iblock/placeholder.gif" data-src="<?= SITE_TEMPLATE_PATH ?>/img/employee-1.jpg">
				<p>Авраменко В. В.</p>
				<p class="grey">Ведущий архитектор</p>
			</div>
			<div class="about-staff__employee">
				<img src="/upload/iblock/placeholder.gif" data-src="<?= SITE_TEMPLATE_PATH ?>/img/employee-2.jpg">
				<p>Алякрицкий А. С.</p>
				<p class="grey">Ведущий архитектор</p>
			</div>
			<div class="about-staff__employee">
				<img src="/upload/iblock/placeholder.gif" data-src="<?= SITE_TEMPLATE_PATH ?>/img/employee-3.jpg">
				<p>Барила Е. В.</p>
				<p class="grey">Руководитель группы архитекторов</p>
			</div>
			<div class="about-staff__employee">
				<img src="/upload/iblock/placeholder.gif" data-src="<?= SITE_TEMPLATE_PATH ?>/img/employee-4.jpg">
				<p>Борисова А. В.</p>
				<p class="grey">Архитектор</p>
			</div>
			<div class="about-staff__employee">
				<img src="/upload/iblock/placeholder.gif" data-src="<?= SITE_TEMPLATE_PATH ?>/img/employee-5.jpg">
				<p>Бушуева Л. Б.</p>
				<p class="grey">Главный архитектор проекта</p>
			</div>
			<div class="about-staff__employee">
				<img src="/upload/iblock/placeholder.gif" data-src="<?= SITE_TEMPLATE_PATH ?>/img/employee-6.jpg">
				<p>Вартанян С. В.</p>
				<p class="grey">Архитектор</p>
			</div>
			<div class="about-staff__employee">
				<img src="/upload/iblock/placeholder.gif" data-src="<?= SITE_TEMPLATE_PATH ?>/img/employee-7.jpg">
				<p>Вечерская П. И.</p>
				<p class="grey">Техник-архитектор</p>
			</div>
			<div class="about-staff__employee">
				<img src="/upload/iblock/placeholder.gif" data-src="<?= SITE_TEMPLATE_PATH ?>/img/employee-8.jpg">
				<p>Волошина М. В.</p>
				<p class="grey">Архитектор 2 категории</p>
			</div>
			<div class="about-staff__employee">
				<img src="/upload/iblock/placeholder.gif" data-src="<?= SITE_TEMPLATE_PATH ?>/img/employee-9.jpg">
				<p>Второва Е. А.</p>
				<p class="grey">Главный архитектор проекта</p>
			</div>
			<div class="about-staff__employee">
				<img src="/upload/iblock/placeholder.gif" data-src="<?= SITE_TEMPLATE_PATH ?>/img/employee-10.jpg">
				<p>Гарпуль А. А.</p>
				<p class="grey">Архитектор 2 категории</p>
			</div>
			<div class="about-staff__employee">
				<img src="/upload/iblock/placeholder.gif" data-src="<?= SITE_TEMPLATE_PATH ?>/img/employee-11.jpg">
				<p>Давлетбаева Ю. Ш.</p>
				<p class="grey">Ведущий архитектор</p>
			</div>
			<div class="about-staff__employee">
				<img src="/upload/iblock/placeholder.gif" data-src="<?= SITE_TEMPLATE_PATH ?>/img/employee-12.jpg">
				<p>Долгих Л. В.</p>
				<p class="grey">Архитектор 1 категории</p>
			</div>
			<div class="about-staff__employee">
				<img src="/upload/iblock/placeholder.gif" data-src="<?= SITE_TEMPLATE_PATH ?>/img/employee-13.jpg">
				<p>Драгошанская И. А.</p>
				<p class="grey">Главный архитектор проекта</p>
			</div>
			<div class="about-staff__employee">
				<img src="/upload/iblock/placeholder.gif" data-src="<?= SITE_TEMPLATE_PATH ?>/img/employee-14.jpg">
				<p>Заводова А. Д.</p>
				<p class="grey">Архитектор</p>
			</div>
			<div class="about-staff__employee">
				<img src="/upload/iblock/placeholder.gif" data-src="<?= SITE_TEMPLATE_PATH ?>/img/employee-15.jpg">
				<p>Зацепина А. Ю.</p>
				<p class="grey">Архитектор I категории</p>
			</div>
			<div class="about-staff__employee">
				<img src="/upload/iblock/placeholder.gif" data-src="<?= SITE_TEMPLATE_PATH ?>/img/employee-16.jpg">
				<p>Земцова Г. А.</p>
				<p class="grey">Руководитель группы архитекторов</p>
			</div>
		</div>
...
<script src="<?= SITE_TEMPLATE_PATH ?>/js/masterplans_detail.min.js"></script>