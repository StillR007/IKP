...
<div class="detail-slider">
	<img class="detail-slider__img" src="<?= SITE_TEMPLATE_PATH ?>/img/Present-test_00.jpg">
	<img class="detail-slider__img" src="<?= SITE_TEMPLATE_PATH ?>/img/Present-test_01.jpg">
	<img class="detail-slider__img" src="<?= SITE_TEMPLATE_PATH ?>/img/Present-test_02.jpg">
	<img class="detail-slider__img" src="<?= SITE_TEMPLATE_PATH ?>/img/Present-test_03.jpg">
	<img class="detail-slider__img" src="<?= SITE_TEMPLATE_PATH ?>/img/Present-test_04.jpg">
	<img class="detail-slider__img" src="<?= SITE_TEMPLATE_PATH ?>/img/Present-test_05.jpg">
	<img class="detail-slider__img" src="<?= SITE_TEMPLATE_PATH ?>/img/Present-test_06.jpg">
	<img class="detail-slider__img" src="<?= SITE_TEMPLATE_PATH ?>/img/Present-test_07.jpg">
	<img class="detail-slider__img" src="<?= SITE_TEMPLATE_PATH ?>/img/Present-test_08.jpg">
	<img class="detail-slider__img" src="<?= SITE_TEMPLATE_PATH ?>/img/Present-test_09.jpg">
	<img class="detail-slider__img" src="<?= SITE_TEMPLATE_PATH ?>/img/Present-test_10.jpg">
	<img class="detail-slider__img" src="<?= SITE_TEMPLATE_PATH ?>/img/Present-test_11.jpg">
	<img class="detail-slider__img" src="<?= SITE_TEMPLATE_PATH ?>/img/Present-test_12.jpg">
	<img class="detail-slider__img" src="<?= SITE_TEMPLATE_PATH ?>/img/Present-test_13.jpg">
	<img class="detail-slider__img" src="<?= SITE_TEMPLATE_PATH ?>/img/Present-test_14.jpg">
	<img class="detail-slider__img" src="<?= SITE_TEMPLATE_PATH ?>/img/Present-test_15.jpg">
	<img class="detail-slider__img" src="<?= SITE_TEMPLATE_PATH ?>/img/Present-test_16.jpg">
	<img class="detail-slider__img" src="<?= SITE_TEMPLATE_PATH ?>/img/Present-test_17.jpg">
	<img class="detail-slider__img" src="<?= SITE_TEMPLATE_PATH ?>/img/Present-test_18.jpg">
	<img class="detail-slider__img" src="<?= SITE_TEMPLATE_PATH ?>/img/Present-test_19.jpg">
	<img class="detail-slider__img" src="<?= SITE_TEMPLATE_PATH ?>/img/Present-test_20.jpg">
	<img class="detail-slider__img" src="<?= SITE_TEMPLATE_PATH ?>/img/Present-test_21.jpg">
	<img class="detail-slider__img" src="<?= SITE_TEMPLATE_PATH ?>/img/Present-test_22.jpg">
	...
	<div class="popup">
		<div class="popup-body">
			<div class="popup-content">
				...
				<div class="popup-content--title">Поделиться фотографией</div>
				<div class="popup-content--text">Поделитесь фотографией с коллегами и друзьями, скопируйте ссылку
